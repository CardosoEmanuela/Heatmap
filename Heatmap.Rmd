...
data <- read.csv("Virulencia_2603.csv", check.names = FALSE)
rnames <- data[,1]                            
...
pheatmap(
  #Matriz numerica dos valores a serem tracados
  mat = data,
 ...
 #Quadro de dados que especifica as anotacoes mostradas no lado esquerdo (row) ou 
  # acima (col) do mapa de calor
  annotation_row = NA,
  annotation_col = uniao_dataframe,
  # Lista para especificar as cores das trilhas 
  annotation_colors = NA,
  # Trilhas de anotacao deve ser desenhada
  annotation_legend = TRUE,
 #Mostrando se os nomes das trilhas de anotacao de linha ou  coluna devem ser desenhados
  ...
  labels_col = NULL,
  # salvar arquivo
  filename = "C:/Users/Emanuela/Desktop/heatmap_virulencia_2603.png",
